    ...
    <div className="bg-muted/30 flex min-h-screen items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center gap-2">
          ...
          <p className="text-muted-foreground text-sm">One last step!</p>
        </div>

        <Card>
          <CardHeader>
            <CardTitle>Set up your family</CardTitle>
            <CardDescription>Create a family household to start tracking expenses</CardDescription>
          </CardHeader>
          <CardContent>
            <form action={action} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="familyName">Family name</Label>
                <Input id="familyName" name="familyName" placeholder="Kumar Household" required />
              </div>
